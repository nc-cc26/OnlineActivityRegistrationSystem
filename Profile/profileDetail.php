            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="profileDetail.html">Detail<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="updatePersonal.html">Update</a>
                    </li>
                </ul>
        ...
        <main class="jumbotron mt-2">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link bg-light" href="profileDetail.html">Personal <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="academicDetail.html">Academic</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="contactDetail.html">Contact</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <script type="text/javascript">
                ...
                button.addEventListener("click", function() {
                    ...
                    if (x) window.location.href = "updatePersonal.html";
                    else return false;
                });
            </script>
        </main>
